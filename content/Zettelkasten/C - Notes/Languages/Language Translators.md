...
- Bytecode is designed to be executed by a Language Virtual Machine. This is different from [[3 - Zettelkasten/C - Notes/CyberSecurity/Setting Up Virtual Machine or Lab|System Virtual Machine]].
...
**[[3 - Zettelkasten/C - Notes/CyberSecurity/Setting Up Virtual Machine or Lab|System Virtual Machine]]**
- Runs an entire operating system inside another OS.
- Examples: [[3 - Zettelkasten/C - Notes/CyberSecurity/Setting Up Virtual Machine or Lab#**VirtualBox**|VirtualBox]], [[3 - Zettelkasten/C - Notes/CyberSecurity/Setting Up Virtual Machine or Lab#**VMware**|VMware]], [[3 - Zettelkasten/C - Notes/CyberSecurity/Setting Up Virtual Machine or Lab#🪟 **Hyper-V** (Microsoft)|Hyper-V]].
