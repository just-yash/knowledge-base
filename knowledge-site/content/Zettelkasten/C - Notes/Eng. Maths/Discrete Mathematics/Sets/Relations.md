...
- match it with the elements u have, the ones you don't have are the closure elements
...
- [[POSET]] : Partial Order Set 
	- Denoted by $[A, R]$
- it will form a **partial** [[2 - Zettelkasten/C - Notes/Eng. Maths/Linear Algebra/Matrix#^5cfafd|Upper Triangular Matrix]]
###### Example
...
- it will form a complete [[2 - Zettelkasten/C - Notes/Eng. Maths/Linear Algebra/Matrix#^5cfafd|Upper Triangular Matrix]]
###### Example 
...
2. [[Set Theory]]
3. [[2 - Zettelkasten/C - Notes/Eng. Maths/Linear Algebra/Matrix|Matrix]]
