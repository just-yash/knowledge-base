...
- cos(θ+m) decision boundary is directly trigonometric → [[Trigonometric Formulas]]
- Hypersphere normalization uses matrix operations → [[Matrix]]
- Angular margin operates in geometric space → [[Coordinate Geometry]]  
