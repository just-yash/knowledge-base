...
- Triplet mining is a combinatorial search problem → [[Algorithm Basics]]
- Margin α defines a probabilistic decision boundary → [[Probability Introduction]]
- Relative distances rather than fixed classes → [[Set Theory]] (relations, not classification)
