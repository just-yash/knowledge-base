...
- Feeds into → [[Multi-Object Tracking]] (bounding boxes are tracker input)
- Related to → [[Object Detection]]
- Precision/Recall are statistical measures → [[Probability Introduction]]
- Sliding window is brute-force search → [[Algorithm Basics]]
