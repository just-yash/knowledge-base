...
- Used by → [[Tracking-by-Detection]] ; [[ReID]] ; [[Multi-Object Tracking]]
- Related to → [[Similarity Metrics]] ; [[Embedding Space]]
- Threshold τ is a posterior probability decision boundary → [[Baye's Theorem]]
- argmax and ANN are fundamental algorithmic operations → [[Algorithm Basics]]
- ANN relates to sorted nearest neighbor retrieval → [[Sorting]]
- False positive/negative tradeoff is probabilistic → [[Probability Introduction]]
